...
RZ_IPI bool rz_frida_backend_class_load_monitor(RZ_NONNULL RzFridaSession *session, RZ_UNUSED bool enable, RZ_NONNULL PJ *pj) {
	rz_return_val_if_fail(session && pj, false);
	rz_frida_json_error(pj, RZ_FRIDA_ERROR_FRIDA_UNAVAILABLE, "frida-core support is not enabled");
	return false;
}
...
RZ_IPI bool rz_frida_backend_rn_set(RZ_NONNULL RzFridaSession *session, RZ_UNUSED bool enable, RZ_NONNULL PJ *pj) {
	rz_return_val_if_fail(session && pj, false);
	rz_frida_json_error(pj, RZ_FRIDA_ERROR_FRIDA_UNAVAILABLE, "frida-core support is not enabled");
	return false;
}
...
RZ_IPI bool rz_frida_backend_flag_import(RZ_NONNULL RzFridaSession *session, RZ_NONNULL RZ_UNUSED RzCore *core, RZ_NONNULL PJ *pj) {
	rz_return_val_if_fail(session && pj, false);
	rz_frida_json_error(pj, RZ_FRIDA_ERROR_FRIDA_UNAVAILABLE, "frida-core support is not enabled");
	return false;
}

RZ_IPI bool rz_frida_backend_dex_diff(RZ_NONNULL RzFridaSession *session, RZ_NONNULL RZ_UNUSED RzCore *core, RZ_UNUSED RZ_NULLABLE const char *prefix, RZ_NONNULL PJ *pj) {
	rz_return_val_if_fail(session && core && pj, false);
	rz_frida_json_error(pj, RZ_FRIDA_ERROR_FRIDA_UNAVAILABLE, "frida-core support is not enabled");
	return false;
}
